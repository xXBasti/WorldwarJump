...
\hyperlink{class_physics_calc_a8d6de304c47a3b6be6fdfd7bacd3dcd2}{Physics\+Calc\+::calculate\+New\+Values} calculates the next position of the given \hyperlink{class_world_object}{World\+Object} based on it\textquotesingle{}s current position and its current speed. Then it sets the object\textquotesingle{}s new position and new speed When the \hyperlink{class_world_object}{World\+Object} moves below the ground (collision) the movement speed of the \hyperlink{class_world_object}{World\+Object} is inverted. 


\begin{DoxyParams}{Parameters}
{\em world\+Object} & the \hyperlink{class_world_object}{World\+Object} instance for which new position \\
\hline
\end{DoxyParams}
...
\hyperlink{class_physics_calc_aac58c297992ee6fd388ff29c839c5693}{Physics\+Calc\+::check\+Health} This function checks if the given object has healtpoint lower or eqaul to zero and destroyes that unit. The unitcounter of the owining player will be decreased too. 
...
\hyperlink{class_physics_calc_ad6d0e0e75ce2a00c15a883531f454233}{Physics\+Calc\+::\+Collide\+With\+Unit} This function checks, if an object collides with an other object of the type \hyperlink{class_battle_unit}{Battle\+Unit} or \hyperlink{class_projectile}{Projectile} and returns that object. 
...
\hyperlink{class_physics_calc_af038d3a5fe0160410456b14601a95581}{Physics\+Calc\+::eul\+To\+Pol} This function translates the given cartesian coordinate system to a polar coordinate system and saves them into a given output pointer. 


\begin{DoxyParams}{Parameters}
{\em eul} & inputpointer in cartesian coordinates \\
\hline
{\em pol} & outputpointer in polar coordinates \\
\hline
...
\hyperlink{class_physics_calc_a75c4cfbeb112120f4ffd4839182ca25c}{Physics\+Calc\+::hit\+Unit} This function calculates the damage, between two colliding objects and checks one of the \hyperlink{class_world_object}{World\+Object} get destroyed. 
...
\hyperlink{class_physics_calc_ad30acc4f9a1111e1d611aa943aff53a3}{Physics\+Calc\+::impuls} This function excecutes the conservation of the linear momentum for the two colliding objects obj1 and obj2. 
...
\hyperlink{class_physics_calc_a22379e7ef119411e03fc8c4ba211c724}{Physics\+Calc\+::inverse\+Speed}. 
...
\hyperlink{class_physics_calc_a10a603c3fb290521b301a19600c067c4}{Physics\+Calc\+::meele\+Damage}. 
...
\hyperlink{class_physics_calc_a441c3e94fe0e6eed1d96531368f50d54}{Physics\+Calc\+::pol\+To\+Eul}. 
...
\begin{DoxyParams}{Parameters}
{\em the} & Worldobject to be updated \\
\hline
\end{DoxyParams}
...
\hyperlink{class_physics_calc_aae5264bd415c1cccac4bd4628cb015a0}{Physics\+Calc\+::velocity\+Euler\+To\+Radial\+Coordinates}. 


\begin{DoxyParams}{Parameters}
{\em eul\+Input\+Position} & objects position \\
\hline
{\em eul\+Input\+Velocity} & objects velocity \\
\hline
{\em radial\+Output} & first direction is radial, second directions is tangential \\
\hline
{\em euler\+To\+Radial} & true if transforming from euler to radial, or false if transforming from radial to euler \\
\hline
\end{DoxyParams}
